...
# Visualisation de la performance: 10 images originales et leurs recostructions
...
# Assignation d'un couleur a chaque chiffre pour pouvoir visualiser l'espace latent
def colors(labels):
...
# Preparation des encodages pour une visualisation:
...
# Décodage d'un morceau de l'espace latent
num_digits = 20
digit_size = 28
